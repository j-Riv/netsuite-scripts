 ...
 *
*/
define(['N/record', 'N/log', './usps/validateAddress', './usps/getRateByService', './itemFulfillmentTotals', './testBox/selectBox'],
  function (record, log, uspsValidateAddress, uspsGetRates, itemFulfillmentTotal, boxSelector) {
